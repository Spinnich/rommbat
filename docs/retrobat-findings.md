...
any probe wrote anything. `tools/m6-probes/m6-probe9-es-settings-two-writer.py` is staged and
not yet run; `m6-redact-es-settings.py` produced the checked-in fixture.
