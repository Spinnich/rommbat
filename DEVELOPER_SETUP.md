...
server the client claims to work with. Since the floor tracks the newest stable, that is also
the newest release. The preferred source is the project's public demo, which anyone can
