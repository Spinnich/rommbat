...
public static class RomMServerVersion
{
    ...
    /// </remarks>
    public static ProductVersion Minimum { get; } = ProductVersion.Parse("5.3.0-alpha.3");

    /// <summary>
    /// Newest RomM this release has been exercised against. Keep in step with the README
    /// compatibility table.
    /// </summary>
    public static ProductVersion LastTested { get; } = ProductVersion.Parse("5.3.0-alpha.3");
