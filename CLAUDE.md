...
release names its minimum RomM and RetroBat versions. Currently RetroBat 8.2.1, RomM
5.3.0-alpha.2, a prerelease, so RomM 5.2.0, the newest stable, is refused. Check both at
